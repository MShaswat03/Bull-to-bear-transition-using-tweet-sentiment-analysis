...
def add_technical_indicators(df):
    """Add advanced technical indicators for feature engineering."""
    ...
    # Drop NaN after adding indicators
    df.dropna(inplace=True)
    return df


def run_feature_engineering():
    df = pd.read_csv("results/merged_all_data_classification.csv")
    ...
    print("✅ Enriched data saved to results/merged_all_data_enriched.csv")
